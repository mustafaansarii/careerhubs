...
import { JavaTopics } from '../ALLtutorils'
        ...
        <div key={category.category} className="relative  dark:bg-gray-800 dark:text-white ">
            ...
            <div className="pl-4">
                ...
                <button
                    ...
                    onClick={() => {
                    setSelectedTopic(topic);
                        handleTopicClick(topic.prompt, topic.id, 'java');
        ...
        <div className="flex flex-col min-h-screen mt-15 md:mt-15 dark:text-white">
            ...
            >
                ...
                <div className="p-4 pt-5 border-b bg-gray-50 dark:bg-gray-800 sticky top-0 z-10 backdrop-blur-sm">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Java Topics</h2>
                    <button
                        onClick={() => setIsMobileMenuOpen(false)}
            ...
            >
                <h2 className="text-xl font-bold mb-4 dark:text-white">Java Tutorials</h2>
