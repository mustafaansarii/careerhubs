...
import { FlaskTopics } from '../../ALLtutorils'
...
const FlaskTutorials = () => {
        ...
        <div key={category.category} className="relative  dark:bg-gray-800 dark:text-white ">
            ...
            <div className="pl-4">
                ...
                <button
                    ...
                    onClick={() => {
                    setSelectedTopic(topic);
                        handleTopicClick(topic.prompt, topic.id, 'flask');
    ...
    const toggleCompletion = (topicId) => {
        ...
        setCompletedTopics(prev => {
            ...
            localStorage.setItem('completedflaskTopics', JSON.stringify(newState));
            return newState;
        });
    };
    ...
    return (
        ...
        <div className="flex flex-col min-h-screen mt-15 md:mt-15 dark:text-white">
            ...
            >
                ...
                <div className="p-4 pt-5 border-b bg-gray-50 dark:bg-gray-800 sticky top-0 z-10 backdrop-blur-sm">
                    <div className="flex justify-between items-center w-full">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white">Flask Topics</h2>
                    <button
                        onClick={() => setIsMobileMenuOpen(false)}
            ...
            >
                <h2 className="text-xl font-bold mb-4 dark:text-white">Flask Tutorials</h2>
            ...
            <div className="flex-1 p-4 sm:p-6 md:p-8 md:ml-64 lg:ml-72">
                ...
                <div className="mb-8">
                    ...
                    <ol className="inline-flex items-center space-x-1 text-sm">
                        ...
                        <li className="inline-flex items-center">
                        <ChevronRightIcon className="w-4 h-4 mx-2 text-gray-400" />
                        <span className="text-indigo-600">Flask</span>
                        </li>
                    </ol>
                    </nav>
