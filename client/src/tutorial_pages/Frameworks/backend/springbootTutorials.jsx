...
import { SpringbootTopics } from '../../ALLtutorils'
...
const SpringbootTutorials = () => {
        ...
        <div key={category.category} className="relative  dark:bg-gray-800 dark:text-white ">
            ...
            <div className="pl-4">
                ...
                <button
                    ...
                    onClick={() => {
                    setSelectedTopic(topic);
                        handleTopicClick(topic.prompt, topic.id, 'node');
    ...
    const toggleCompletion = (topicId) => {
        ...
        setCompletedTopics(prev => {
            ...
            localStorage.setItem('completedspringbootTopics', JSON.stringify(newState));
            return newState;
        });
    };
        ...
        <div className="flex flex-col min-h-screen mt-15 md:mt-15 dark:text-white">
            ...
            >
                ...
                <div className="p-4 pt-5 border-b bg-gray-50 dark:bg-gray-800 sticky top-0 z-10 backdrop-blur-sm">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Springboot Topics</h2>
                    <button
                        onClick={() => setIsMobileMenuOpen(false)}
            ...
            >
                <h2 className="text-xl font-bold mb-4 dark:text-white">Springboot Tutorials</h2>
                ...
                {topics.map((category) => (
                    ...
                    <ul className="space-y-1 dark:text-white">
                        ...
                        <li key={topic.id}>
                            ...
                            onClick={() => {
                                setSelectedTopic(topic);
                                handleTopicClick(topic.prompt, topic.id, 'springboot');
                            }}
            ...
            <div className="flex-1 p-4 sm:p-6 md:p-8 md:ml-64 lg:ml-72">
                ...
                <div className="mb-8">
                    ...
                    <ol className="inline-flex items-center space-x-1 text-sm">
                        ...
                        <li className="inline-flex items-center">
                        <ChevronRightIcon className="w-4 h-4 mx-2 text-gray-400" />
                        <span className="text-indigo-600">Springboot</span>
                        </li>
                    </ol>
                    </nav>
