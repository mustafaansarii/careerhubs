...
import { AngularTopics } from '../../ALLtutorils'
...
const AngularTutorials = () => {
        ...
        <div key={category.category} className="relative  dark:bg-gray-800 dark:text-white ">
            ...
            <div className="pl-4">
                ...
                <button
                    ...
                    onClick={() => {
                    setSelectedTopic(topic);
                        handleTopicClick(topic.prompt, topic.id, 'angular');
    ...
    const toggleCompletion = (topicId) => {
        ...
        setCompletedTopics(prev => {
            ...
            localStorage.setItem('completedangularTopics', JSON.stringify(newState));
            return newState;
        });
    };
        ...
        <div className="flex flex-col min-h-screen mt-15 md:mt-15 dark:text-white">
            ...
            >
                ...
                <div className="p-4 pt-5 border-b bg-gray-50 dark:bg-gray-800 sticky top-0 z-10 backdrop-blur-sm">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Angular Topics</h2>
                    <button
                        onClick={() => setIsMobileMenuOpen(false)}
            ...
            >
                <h2 className="text-xl font-bold mb-4 dark:text-white">Angular Tutorials</h2>
            ...
            <div className="flex-1 p-4 sm:p-6 md:p-8 md:ml-64 lg:ml-72">
                ...
                <div className="mb-8">
                    ...
                    <ol className="inline-flex items-center space-x-1 text-sm">
                        ...
                        <li className="inline-flex items-center">
                        <ChevronRightIcon className="w-4 h-4 mx-2 text-gray-400" />
                        <span className="text-indigo-600">Angular</span>
                        </li>
                    </ol>
                    </nav>
                ...
                <div className="mt-12 flex justify-between items-center border-t border-gray-200 pt-6">
                    ...
                    <button
                        ...
                        if (prevTopic) {
                            ...
                            handleTopicClick(prevTopic.prompt, prevTopic.id, 'angular');
                        }
                        }}
                    ...
                    <button
                        ...
                        if (nextTopic) {
                            ...
                            handleTopicClick(nextTopic.prompt, nextTopic.id, 'angular');
                        }
                        }}
